...
<link href="booking tours/tour-book.css" rel="stylesheet" type="text/css">
...
<br/><br/><br/><br/>
    		<h3 style="text-align:center">BOOK A TOUR</h3><br/>
		
	<div class="content">	
	<div class="booking-form">
		<form method="POST" action="Booknow.php" id="bn_form">
			<table id="booking-form">
				<tr>
					<td colspan="2" style="text-align: center"><h4>Your details</h4></td>
				</tr>
				<tr>
					<td>Full Name:</td>
					<td><input type="text" id="fname" name="fname" placeholder="A.V.S. Thilakarathne" required></td>
				</tr>
				<tr>
					<td>National Identity Number:</td>
					<td><input type="text" id="lname" name="lname" placeholder="1990xxxxxxxx" required></td>
				</tr>
				<tr>
					<td>Address:</td>
					<td><textarea rows="5" cols="90" id="add" name="add"></textarea></td>
				</tr>
				<tr>
					<td>Email:</td>
					<td><input type="email" id="email" name="lastname" placeholder="thilakarathneAVS@gmail.com" required></td>
				</tr>
				<tr>
					<td>Mobile: </td>
					<td><input type="tel" id="Mobile" name="Mobile" placeholder="0xx-xxxxxxx" required></td>
				</tr>
				<tr>
					<td colspan="2" style="text-align: center"><h4>tour details</h4></td>
				</tr>
				<tr>
					<td>Tour destination: </td>
					<td> <select id="location" name="TourDestination">
				...
				<tr>
					<td>Tour duration: </td>
					<td><input type="text" name="duration" id="tourDue" required></td>
				</tr>
				<tr>
					<td>Number of travellers - adults: </td>
					<td><input type="number" name="trvelAdult" id="adult" required></td>
				</tr>
				<tr>
					<td>Number of travellers - children: </td>
					<td><input type="number" name="travelKids" id="kids" required></td>
				</tr>
				<tr>
					<td colspan="2" style="text-align: right"><input class="btn btn-dark" type="submit" name="submit" value="Book now" style="font-family: 'Ysabeau SC', sans-serif"/></td>
				</tr>
			</table> 
 ...
 <footer>
  ...
  <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016a5.54 5.54 0 0 1 .016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z"/>
    ...
    <script language="javascript" type="text/javascript">
        const form = document.getElementByID('bn_form'):
        ...
        function validateForm() {
            ...
            alert('Name should have between 3 and 20 characters.');
            return false;
        }
    
        if (email.length < 3 || email.length > 20) {
            alert('Email should have between 3 and 20 characters.');
            return false;
        }
    
     
        if (!/^\d{12}$/.test(nic)) {
            alert('NIC should have exactly 12 digits and only contain numbers.');
            return false;
        }
    
        if (!/^\d{10}$/.test(mobile)) {
            alert('Mobile should have exactly 10 digits and only contain numbers.');
            return false;
        }
    
    
        if (adultCount < 0 || kidCount < 0) {
            alert('Number of travelers cannot be negative.');
            return false;
        }
