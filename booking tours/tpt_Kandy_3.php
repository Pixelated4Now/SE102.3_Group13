...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r" crossorigin="anonymous"></script>
  <style>
	  body {
	background-image: url('../images/kandy/kandy20.jpg'); /* Specify the path to your background image */
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light container-fluid"> <a class="navbar-brand" href="../index.php"><img src="../images/Logo.png" width="100" alt="Logo of Ceylon Odyssey"/>&nbsp;</a>
	  ...
	  <br/><br/><br/><br/>
	  <img src="../images/kandy/kandy0.png" alt="" width="1250" height="600" class="img-fluid" style = "border: 2px solid #000000;"/>
		<br><br><br> <!--src="images/kandy/kandy3.jpg"-->
		<div class="content">
	  <h2>KANDY</h2>
		<p>A tour to Kandy takes visitors on an exhilarating journey through the centre of Sri Lanka's natural and cultural resources. The well-known Temple of the Tooth Relic is the first thing that draws tourists in, as they learn about the site's spiritual and historical value. Amidst incredible natural beauty, there are calm sanctuaries to be found at the picturesque Kandy Lake and the Royal Botanic Gardens in Peradeniya. Observing the architecture of the colonial era in the city — such as the Old Royal Palace and the Queen's Hotel — proffers insights into the city's history. Traveling to neighbouring sites such as the lush tea estates and the Pinnawala Elephant Orphanage provides a fascinating diverse experience.Travelers will have a wonderful time on their Kandy trip, which blends the most wonderful parts of Sri Lankan history, culture, and natural beauty.</p>
		<br><br><hr><br>
		<h3>DURATION</h3>
		<p>4 days</p>
			<br>
		...
		<ul class="included" style="color: antiquewhite" >
				<li >Temple of Tooth Relic</li><li >Peradeniya Botanical Garden</li><li >Ambuluwawa Tower</li><li >Embekke</li><li >Pinnawal Elephant Ophanage</li><li>Kandyan Cultural Show</li><li>Spice Garden</li><li >Riverston</li>
		</ul>
			<hr>
        <h3 style="color: white">GALLERY</h3>
        <div class="tpt_row">
          <img src="../images/kandy/kandy1.jpg" alt="" class="img-fluid" />
          <img src="../images/kandy/kandy13.jpg" alt="" class="img-fluid"/>
		  <img src="../images/kandy/kandy6.jpg" alt="" class="img-fluid"/>
          <img src="../images/kandy/kandy2.jpg" alt="" class="img-fluid"/>
          <img src="../images/kandy/kandy4.jpg" alt="" class="img-fluid"/>
          <img src="../images/kandy/kandy19.jpeg" alt="" class="img-fluid"/>
          <img src="../images/kandy/kandy11.jpg" alt="" class="img-fluid"/>
          <img src="../images/kandy/kandy9.jpg" alt=""class="img-fluid"/>
          <img src="../images/kandy/kandy8.jpg" alt=""class="img-fluid"/>
        </div>
       <br/>
		<hr>
