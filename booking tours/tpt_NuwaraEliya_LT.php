...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r" crossorigin="anonymous"></script>
  <style>
	  body {
	background-image: url('../images/nuwaraeliya/NE2.jpg'); /* Specify the path to your background image */
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light container-fluid"> <a class="navbar-brand" href="../index.php"><img src="../images/Logo.png" width="100" alt="Logo of Ceylon Odyssey"/>&nbsp;</a>
	  ...
	  <h2>NUWARA ELIYA TOUR</h2>
		...
		<ul  style="color: antiquewhite" >
				<li >Hakgala Botanical Garden</li><li >Gregory Lake</li><li>Lover's Leap Fall</li><li>Strawberry Fields</li> <li >Horton Plains National Park</li><li>Ambewela farms</li><li >Bluefield Tea Garden and Factory</li><li>Seetha Amman Kovil</li><li>Bale Bazaar</li><li>St Clair's Falls</li><li>Piduruthalagala Mountain</li><li>Bomburu Ella Falls</li>
		</ul>
			<hr>
        <h3 style="color: white">GALLERY</h3>
        <div class="tpt_row">
          <img src="../images/nuwaraeliya/NE10.jpeg" alt="" class="img-fluid" />
          <img src="../images/nuwaraeliya/NE11.jpeg" alt="" class="img-fluid" />
			<img src="../images/nuwaraeliya/NE12LL.jpeg" alt="" class="img-fluid" />
			<img src="../images/nuwaraeliya/NE13SB.jpeg" alt="" class="img-fluid" />
			<img src="../images/nuwaraeliya/NE14HP.jpeg" alt="" class="img-fluid" />
			<img src="../images/nuwaraeliya/NE15AF.jpeg" alt="" class="img-fluid" />
			<img src="../images/nuwaraeliya/NE16BT.jpeg" alt="" class="img-fluid" />
			<img src="../images/nuwaraeliya/NE17SA.jpeg" alt="" class="img-fluid" />
			<img src="../images/nuwaraeliya/NE18BB.jpeg" alt="" class="img-fluid" />
			<img src="../images/nuwaraeliya/NE19SC.jpeg" alt="" class="img-fluid" />
			<img src="../images/nuwaraeliya/NE20PM.jpg" alt="" class="img-fluid" />
			<img src="../images/nuwaraeliya/NE21BE.jpeg" alt="" class="img-fluid" />
        </div>
       <br/>
		<hr>
