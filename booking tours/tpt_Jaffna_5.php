...
<link href="tour-book.css" rel="stylesheet" type="text/css">
<link href="../css/bootstrap-4.4.1.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r" crossorigin="anonymous"></script>
  <style>
	  body {
	background-image: url('../images/jaffna/jaffna14.jpg'); /* Specify the path to your background image */
  ...
  <div class="container-fluid">
    <div class="container">
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light container-fluid"> <a class="navbar-brand" href="../New folder/index.php"><img src="../images/Logo.png" width="100" alt="Logo of Ceylon Odyssey"/>&nbsp;</a>
	  ...
	  <br/><br/><br/><br/>
	  <img src="../images/jaffna/jaffna17.jpg" alt="" width="1250" height="602" class="img-fluid" style = "border: 2px solid #000000;"/>
		<br><br><br>
		<div class="content">
	  <h2>JAFFNA</h2>
		<p>Jaffna, near the island’s northernmost tip, is one of the country’s most picturesque cities. Jaffna is the cultural centre of Sri Lanka’s Tamil community because of its large Tamil population. Any visitor to this area will be blown away by the warmth and friendliness of the residents.
		
		 Visit Jaffna if you’re seeking a place that’s both beautiful and welcoming to visitors..
			
		Visit prominent tourist destinations including Jaffna Fort, Jaffna Public Library, Sangiliyan Thoppu, and Manthri Manai. Offer prayers at Naga Vihara and Nallur Kandaswamy Temple. You will get meaningful insights from a professional English-speaking guide throughout the tour.</p>
		<br><br><hr><br>
		<h3>DURATION</h3>
		<p>5 days</p>
			<br>
		...
		<div class="included">
			<ul style="color: antiquewhite" >
				<li >Accomodations</li><li >Meals</li><li >Personal guide</li><li >Transportation</li>
				</ul></div>
			<hr>
		<h3>places to visit</h3>
		<ul class="included" style="color: antiquewhite" >
				<li >Temple of Nallur</li><li >Nagadeepa</li><li >Manalkadu beach</li><li >Point Pedro</li><li >Jaffna Fort</li><li >Jaffna Archaeological Museum</li><li>Jaffna Library</li>
				</ul>
			<hr>
        <h3 style="color: white">GALLERY</h3>
        <div class="tpt_row">
          <img src="../images/jaffna/jaffna11.jpeg" alt="" class="img-fluid" />
          <img src="../images/jaffna/jaffna2.jpg" alt="" class="img-fluid"/>
		  <img src="../images/jaffna/jaffna3.jpg" alt="" class="img-fluid"/>
          <img src="../images/jaffna/jaffna4.jpg" alt="" class="img-fluid"/>
          <img src="../images/jaffna/jaffna5.jpg" alt="" class="img-fluid"/>
          <img src="../images/jaffna/jaffna6.jpg" alt="" class="img-fluid"/>
          <img src="../images/jaffna/jaffna7.jpg" alt="" class="img-fluid"/>
          <img src="../images/jaffna/jaffna8.jpg" alt=""class="img-fluid"/>
          <img src="../images/jaffna/jaffna12.jpeg" alt=""class="img-fluid"/>
        </div>
       <br/>
		<hr>
		<div style="text-align: right"><a href="../bookingForm.php"><input class="btn btn-dark" type="submit" name="submit" value="Book now" style="font-family: 'Ysabeau SC', sans-serif"/></a>
		</div>
  ...
  <!-- body code goes here -->
	...
	<script src="../New folder/js/popper.min.js"></script> 
  <script src="../New folder/js/bootstrap-4.4.1.js"></script>
