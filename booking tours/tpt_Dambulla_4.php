...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r" crossorigin="anonymous"></script>
  <style>
	  body {
	background-image: url('../images/dambulla/dambulla9.jpg'); /* Specify the path to your background image */
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light container-fluid"> <a class="navbar-brand" href="../index.php"><img src="../images/Logo.png" width="100" alt="Logo of Ceylon Odyssey"/>&nbsp;</a>
	  ...
	  <br/><br/><br/><br/>
	  <img src="../images/tourTemplatecarousal.jpg" alt="" width="1250" height="714" class="img-fluid" style = "border: 2px solid #000000;"/>
		<br><br><br>
		<div class="content">
	  <h2>DAMBULLA</h2>
		<p>Your travel plan for Sri Lanka should include a visit to the picturesque and religious historic town of Dambulla. Our visitors adore the breathtaking Dambulla Cave Temples - after all, it's quite impossible that more than 150 Buddha sculptures could actually exist peacefully alongside the statues of old Ceylonese monarchs, gods, and goddesses. It is impossible to describe the sense of excitement that one experiences when entering one of the world's perfectly preserved temple structures. Visitors have the chance to see ancient discoveries such as the "Ibbankatuwa Megalithic Tombs." A trip to Dambulla and Sigiriya in Sri Lanka promises a captivating journey through the island's rich history, culture, and natural beauty.</p>
		<br><br><hr><br>
		<h3>DURATION</h3>
		<p>4 days</p>
			<br>
		...
		<ul style="color: antiquewhite" >
				<li >Sigiriya The Ancient Rock Fortress</li><li >Pidurangala Rock</li><li >Golden Temple of Dambulla</li><li >Ibbankatuwa</li><li >Sri Muthumariamman Temple, Matale</li><li > Minneriya or kaudulla national park Wild safari</li><li>Spice garden</li><li>Mihinthale</li>
				</ul>
			<hr>
        <h3 style="color: white">GALLERY</h3>
        <div class="tpt_row">
          <img src="../images/dambulla/dambulla18.jpg" alt="" class="img-fluid" />
          <img src="../images/dambulla/dambulla2.jpg" alt="" class="img-fluid"/>
          <img src="../images/dambulla/dambulla11.jpg" alt="" class="img-fluid"/>
          <img src="../images/dambulla/dambulla7.jpg" alt="" class="img-fluid"/>
          <img src="../images/dambulla/dambulla3.jpg" alt="" class="img-fluid"/>
          <img src="../images/dambulla/dambulla17.jpeg" alt="" class="img-fluid"/>
          <img src="../images/dambulla/dambulla16.jpg" alt="" class="img-fluid"/>
          <img src="../images/dambulla/dambulla13.jpg" alt=""class="img-fluid"/>
          <img src="../images/dambulla/dambulla12.jpg" alt=""class="img-fluid"/>
        </div>
       <br/>
		<hr>
