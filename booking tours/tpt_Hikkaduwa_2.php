...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r" crossorigin="anonymous"></script>
  <style>
	  body {
	background-image: url('../images/hikkaduwa/hikkaduwa12.jpg'); /* Specify the path to your background image */
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light container-fluid"> <a class="navbar-brand" href="../index.php"><img src="../images/Logo.png" width="100" alt="Logo of Ceylon Odyssey"/>&nbsp;</a>
	  ...
	  <br/><br/><br/><br/>
	  <img src="../images/hikkaduwa/hikkaduwa11.jpg" alt="" width="1250" height="714" class="img-fluid" style = "border: 2px solid #000000;"/>
		<br><br><br>
		<div class="content">
	  <h2>HIKKADUWA</h2>
		<p>Tourists love this city for the unique opportunity to swim in the ocean with turtles that come close to the shore to eat seaweed. On the way to Hikkaduwa, we will have a rich program: a boat trip through the mangroves, a visit to the Turtle Hatchery, the Mask Museum and the Moonstone Mine. In addition, Hikkaduwa is very famous for its long sandy beach; west-coast Hikkaduwa also boasts good waves for surfers, reefs for snorkelers and divers, plus sand-side hotels, restaurants, and bars. Add an island temple, tsunami museum, and turtle sanctuary - and you have one of Sri Lanka’s best beach-holiday haunts.</p>
		<br><br><hr><br>
		<h3>DURATION</h3>
		<p>2 days</p>
			<br>
		...
		<ul style="color: antiquewhite" >
				<li>Hikkaduwa National Park </li><li >Hikkaduwa beach</li><li >Moonstone Mines</li><li >Gangarama Maha Viharaya</li><li >Seenigama Muhudu Viharaya</li><li >Hikkaduwa Lake</li>
				</ul>
			<hr>
			
        <h3 style="color: white">GALLERY</h3>
        <div class="tpt_row">
          <img src="../images/hikkaduwa/hikkaduwa1.jpeg" alt="" class="img-fluid" />
          <img src="../images/hikkaduwa/hikkaduwa2.jpg" alt="" class="img-fluid" />
		  <img src="../images/hikkaduwa/hikkaduwa3.jpeg" alt="" class="img-fluid" />
		  <img src="../images/hikkaduwa/hikkaduwa4.jpeg" alt="" class="img-fluid" />
		  <img src="../images/hikkaduwa/hikkaduwa5.jpeg" alt="" class="img-fluid" />
		  <img src="../images/hikkaduwa/hikkaduwa6.jpeg" alt="" class="img-fluid" />
		  <img src="../images/hikkaduwa/hikkaduwa7.jpeg" alt="" class="img-fluid" />
		  <img src="../images/hikkaduwa/hikkaduwa13.jpg" alt="" class="img-fluid" />
		  <img src="../images/hikkaduwa/hikkaduwa0.jpg" alt="" class="img-fluid" />
        </div>
       <br/>
		<hr>
