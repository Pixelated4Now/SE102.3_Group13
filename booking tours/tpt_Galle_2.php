...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r" crossorigin="anonymous"></script>
  <style>
	  body {
	background-image: url('../images/galle/galle15.jpg'); /* Specify the path to your background image */
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light container-fluid"> <a class="navbar-brand" href="../index.php"><img src="../images/Logo.png" width="100" alt="Logo of Ceylon Odyssey"/>&nbsp;</a>
	  ...
	  <br/><br/><br/><br/>
	  <img src="../images/galle/galle16.jpg" alt="" width="1250" height="714" class="img-fluid" style = "border: 2px solid #000000;"/>
		<br><br><br>
		<div class="content">
	  <h2>GALLE</h2>
		<p>A tour to Galle is a breathtaking step back in time to a captivating world of history and coastal charm. This UNESCO World Heritage-listed city on Sri Lanka's southern coast beckons with its well-preserved colonial architecture, cobbled streets, and the majestic Galle Fort. As you wander through the fort's ramparts, you'll be enchanted by its old-world ambiance and mesmerizing ocean views. Galle's vibrant markets, inviting cafés, and art galleries offer glimpses of local life and culture, while the nearby pristine beaches provide a serene escape. A tour to Galle is an immersion in the island's rich heritage and a delightful journey through a city that seamlessly blends the past and present along the sparkling shores of the Indian Ocean.</p>
		<br><br><hr><br>
		<h3>DURATION</h3>
		<p>2 days</p>
			<br>
		...
		<ul class="included" style="color: antiquewhite" >
				<li >Galle Fort</li><li >Light House</li><li >Hikkaduwa beach</li><li >Hikkaduwa national park</li><li >Sea Turtle Hatchery Center</li><li >National Museum of Galle</li><li >Martin Wickramasinghe House and Folk Museum</li><li >Whale Watching in Mirissa</li>
				</ul>
			<hr>
        <h3 style="color: white">GALLERY</h3>
        <div class="tpt_row">
          <img src="../images/galle/galle2.jpg" alt="" class="img-fluid" />
          <img src="../images/galle/galle3.jpg" alt="" class="img-fluid"/>
		  <img src="../images/galle/galle4.jpg" alt="" class="img-fluid"/>
          <img src="../images/galle/galle10.jpg" alt="" class="img-fluid"/>
          <img src="../images/galle/galle6.png" alt="" class="img-fluid"/>
          <img src="../images/galle/galle7.jpg" alt="" class="img-fluid"/>
          <img src="../images/galle/galle8.jpg" alt="" class="img-fluid"/>
          <img src="../images/galle/galle9.jpg" alt=""class="img-fluid"/>
          <img src="../images/galle/galle11.jpg" alt=""class="img-fluid"/>
        </div>
       <br/>
       <hr/>
