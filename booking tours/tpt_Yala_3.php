...
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r" crossorigin="anonymous"></script>
  <style>
	  body {
	background-image: url('../images/yala/yala17.jpg'); /* Specify the path to your background image */
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light container-fluid"> <a class="navbar-brand" href="../index.php"><img src="../images/Logo.png" width="100" alt="Logo of Ceylon Odyssey"/>&nbsp;</a>
	  ...
	  <br/><br/><br/><br/>
	  <img src="../images/yala/yala18.jpg" alt="" width="1250" height="714" class="img-fluid" style = "border: 2px solid #000000;"/>
		<br><br><br>
		<div class="content">
	  <h2>YALA WILD SAFARI</h2>
		<p>Have you ever gotten the chance to enjoy the comfort of a nest in a dry, deciduous forest? In that case, this is a golden opportunity for you to try the Leopard Nest in a three days' memorable wildlife tour. You may get a chance to witness leopards and many other animals in Yala National park and enjoy the glimpse of Bundala national park and its bird life during this tour. 
		Yala National Park is the most visited and second largest national park in Sri Lanka, bordering the Indian Ocean. The park is best known for its diverse variety of wild animals. It is significant for the conservation of Sri Lankan elephants, Sri Lankan leopards, and aquatic birds. The number of mammals that have been recorded from the park is 44 and it has one of the highest leopard densities in the world.</p>
		<br><br><hr><br>
		<h3>DURATION</h3>
		<p>3 days</p>
			<br>
		...
		<ul class="included" style="color: antiquewhite" >
				<li >Yala National Park</li><li >Ruhunu Maha Kataragama Kovil</li><li >Sithulpauwa Royal Temple</li><li >Kiriwehera</li><li >Maligawatta Buddhist Statue</li>
				</ul>
			<hr>
        <h3 style="color: white">GALLERY</h3>
        <div class="tpt_row">
            <img src="../images/yala/yala0.jpeg" alt="" class="img-fluid" />
			<img src="../images/yala/yala1.jpeg" alt="" class="img-fluid" />
			<img src="../images/yala/yala2.jpeg" alt="" class="img-fluid" />
			<img src="../images/yala/yala3.jpeg" alt="" class="img-fluid" />
			<img src="../images/yala/yala4.jpg" alt="" class="img-fluid" />
			<img src="../images/yala/yala5.jpeg" alt="" class="img-fluid" />
			<img src="../images/yala/yala8.jpeg" alt="" class="img-fluid" />
			<img src="../images/yala/yala6.jpeg" alt="" class="img-fluid" />
			<img src="../images/yala/yala7.jpeg" alt="" class="img-fluid" />
        </div>
       <br/>
		<hr>
