<html lang="en">
  <head>
    ...
    <title>
    Ceylon Odyssey | Customer Reviews</title>
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light bg-light container-fluid"> <a class="navbar-brand" href="index.html"><img src="images/Logo.png" width="100" alt="Logo of Ceylon Odyssey"/>&nbsp;</a>
	...
	<center>
		<div class="contact">
	<form id="feedbackForm" method="POST" action="sending_reviews.php">
		<h2>Let Us Know what you think...</h2>
		<br/>
		<input type="text" class="input" id="fname" name="fullname" autocomplete="off" placeholder="Enter your name" required>
   		<br><br/>
		<input type="text" id="nameOfTour" class="input" name="name_of_tour" autocomplete="off" placeholder="Name of tour" required>
		<br><br/>
   
        <div class="row g-3">
            <div class="col-12">
				<textarea class="input" name="comments" id="userComment" placeholder="Comment here!"  rows="6"></textarea>
            </div>
		</div>
		<br/><br/>
    <input type="submit" id="submit" class="input button" name="submit" value=" Submit ">
		</form></div>
	<br><br>
		...
		if ($result->num_rows > 0) {
		  ...
		  while($row = $result->fetch_assoc()) {
			echo '<div style="background-color: rgba(0, 0, 0, 0.8);color: whitesmoke; border-radius: 10px; padding: 4px; max-width: 80%; text-align: center; margin-bottom: 10px;"><h4>'.$row["name"]. '</h4><h4>' . $row["tourname"]. '</h4><p>' . $row["comments"]. '</p><br><br></div>';
		  }
